 ...
 * delineating pixel positions to draw hexes on.
 ...
 */
export default function(size, precision, pathGen, geo) {
  ...
  const imgData = context.getImageData(0, 0, size[0], size[1]);
  return imgData.data.filter((d,i) => i%4 === 3);
